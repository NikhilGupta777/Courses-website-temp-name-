...
// Next.js will de-opt the entire page to client-side rendering and throw a
// build error during static generation.
// Fix: extract the form into a child component, export the page wrapped in Suspense.
      ...
      <div className="max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 px-4 bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-semibold rounded-xl hover:from-violet-700 hover:to-indigo-700 transition-all shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
          >
...
// Page export wraps the form in Suspense so useSearchParams() doesn't
// cause a build-time static generation error.
