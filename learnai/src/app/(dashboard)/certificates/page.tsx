...
const mockCertificates = [
  {
    id: "cert-1",
    courseTitle: "AI Prompting Fundamentals",
    certificateNumber: "LEARNAI-2026-001234",
    issuedAt: "May 10, 2026",
    verificationUrl: "https://learnai.in/verify/LEARNAI-2026-001234",
    score: 92,
    duration: "4h 30m",
  ...
  {
    id: "cert-2",
    courseTitle: "ChatGPT Basics for Everyone",
    certificateNumber: "LEARNAI-2026-005678",
    issuedAt: "April 28, 2026",
    verificationUrl: "https://learnai.in/verify/LEARNAI-2026-005678",
    score: 88,
    duration: "2h 45m",
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 mt-1">You have earned <strong className="text-violet-600">{mockCertificates.length}</strong> certificate{mockCertificates.length !== 1 ? "s" : ""} so far.</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {mockCertificates.map((cert) => (
              <div key={cert.id} className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-lg transition-all overflow-hidden group">
                {/* Certificate preview */}
                <div className={`relative h-44 bg-gradient-to-br ${cert.color} flex flex-col items-center justify-center p-6`}>
                  ...
                  <div className="text-white text-center">
                    ...
                    <div className="text-lg font-bold leading-tight">{cert.courseTitle}</div>
                ...
                <div className="p-5">
                  <div className="grid grid-cols-3 gap-3 mb-4">
                    <div className="text-center p-2 bg-gray-50 rounded-xl">
                      <div className="text-lg font-bold text-violet-600">{cert.score}%</div>
                      <div className="text-xs text-gray-500">Score</div>
                    </div>
                    <div className="text-center p-2 bg-gray-50 rounded-xl">
                      <div className="text-sm font-bold text-gray-900">{cert.duration}</div>
                  ...
                  <div className="space-y-1.5 mb-4">
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-500">
                      <svg className="w-3.5 h-3.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>
                  ...
                  <div className="flex gap-2">
                    <button className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-gradient-to-r from-violet-600 to-indigo-600 text-white text-sm font-semibold rounded-xl hover:from-violet-700 hover:to-indigo-700 transition-all">
        ...
        <div className="mt-10 bg-gradient-to-r from-violet-50 to-indigo-50 rounded-2xl p-6 border border-violet-100 flex items-center justify-between gap-6 flex-wrap">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Certificates are auto-generated when you finish 100% of a course and score ≥ 70% on the final quiz.</p>
          </div>
