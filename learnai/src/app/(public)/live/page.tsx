...
const pastRecordings = [
  {
    id: "past-1",
    title: "Introduction to Prompt Engineering — Recorded Session",
    instructor: "Rahul Mehta",
    date: "May 2, 2026",
    duration: "75 min",
    views: "2,840",
    topic: "Fundamentals of prompt engineering with live examples",
  },
  {
    id: "past-2",
    title: "Stable Diffusion for Beginners — Live Workshop",
    instructor: "Priya Sharma",
    date: "April 20, 2026",
    duration: "110 min",
    views: "1,920",
    topic: "Full hands-on walkthrough of Stable Diffusion setup and usage",
  },
  {
    id: "past-3",
    title: "AI Tools for Freelancers — Live Masterclass",
    instructor: "Sneha Reddy",
    date: "April 10, 2026",
    duration: "90 min",
    views: "3,100",
    topic: "How to use ChatGPT, Canva AI, and Notion AI to grow your freelance income",
  },
];
...
const howItWorks = [
  ...
  { step: "03", title: "Join on Zoom or Google Meet", desc: "Click the join link at class time. Ask questions live, get answers in real time.", icon: "M15 10l4.553-2.069A1 1 0 0121 8.82v6.36a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" },
      ...
      <div className="bg-violet-50 border-b border-violet-100 py-6">
        <div className="mx-auto max-w-5xl px-4 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {[
            ...
            { label: "Session Recordings", value: "40+" },
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {LIVE_CLASSES.map((cls) => {
              const seatsPercent = Math.round(((cls.maxSeats - cls.seatsLeft) / cls.maxSeats) * 100);
              const isAlmostFull = cls.seatsLeft < cls.maxSeats * 0.15;
              return (
                <div key={cls.id} className={`bg-white rounded-2xl border overflow-hidden shadow-sm hover:shadow-lg transition-all group ${cls.isLive ? "border-red-200 ring-2 ring-red-400/30" : "border-gray-200 hover:border-violet-200"}`}>
                  {/* Top color bar */}
                  <div className={`h-1.5 ${cls.isLive ? "bg-red-500 animate-pulse" : "bg-gradient-to-r from-violet-500 to-indigo-500"}`} />
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-xs text-violet-600 font-medium mb-3">{cls.topic}</p>
                    ...
                    <div className="space-y-2 text-xs text-gray-500 mb-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-400">· {cls.instructorTitle}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <svg className="w-3.5 h-3.5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                        {new Date(cls.date).toLocaleDateString("en-IN", { weekday: "short", day: "numeric", month: "long", year: "numeric" })}
                      </div>
                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-between text-xs mb-1.5">
                        <span className={`font-medium ${isAlmostFull ? "text-orange-600" : "text-gray-600"}`}>
                          {isAlmostFull ? "⚡ Almost full! " : ""}{cls.seatsLeft} of {cls.maxSeats} seats left
                        </span>
                    ...
                    <Link
                      href={cls.isLive ? "#join" : "/register?plan=pro"}
                    ...
                    >
                      {cls.isLive ? "🔴 Join Live Now" : "Register Free →"}
                    </Link>
                  </div>
                </div>
              );
            ...
            {pastRecordings.map((rec) => (
              <div key={rec.id} className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow group">
                ...
                <div className="p-4">
                  ...
                  <p className="text-xs text-violet-600 mb-2">{rec.topic}</p>
