...
// Mock verification lookup — replace with db.certificate.findUnique in production
function getCertificate(certNumber: string) {
  ...
  return certs[certNumber] ?? null;
}

export default function VerifyCertificatePage({ params }: Props) {
  const cert = getCertificate(params.certNumber);
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-2xl font-bold bg-gradient-to-r from-violet-600 to-indigo-600 bg-clip-text text-transparent">LearnAI</span>
          </Link>
            ...
            <div className="p-8">
              ...
              <div className="relative bg-gradient-to-br from-violet-600 via-indigo-700 to-purple-800 rounded-2xl p-8 mb-8 text-center overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <div className="text-yellow-300 font-bold text-xl sm:text-2xl mb-4">
                    {cert.courseTitle}
                  </div>
                  <div className="flex items-center justify-center gap-6 text-xs text-violet-200">
              ...
              <div className="flex items-center gap-3 bg-gray-50 rounded-xl p-4 border border-gray-200">
                ...
                <span className="text-xs text-green-600 bg-green-50 border border-green-200 px-2.5 py-1 rounded-full font-semibold">Verified</span>
              </div>
            </div>
          </div>
        ) : (
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div className="p-8 text-center">
              ...
              <p className="text-gray-500 text-sm mb-2">
                Certificate <code className="bg-gray-100 px-2 py-0.5 rounded text-red-600 font-mono">{params.certNumber}</code> was not found.
              </p>
              <p className="text-gray-400 text-xs mb-6">
                Please check the certificate number and try again. If the issue persists, contact <a href="mailto:support@learnai.in" className="text-violet-600 hover:underline">support@learnai.in</a>
              </p>
              <Link href="/" className="inline-flex items-center gap-2 px-6 py-3 bg-violet-600 text-white font-semibold rounded-xl hover:bg-violet-700 transition-colors">
                ← Back to LearnAI
              </Link>
            </div>
          </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          LearnAI Certificate Verification · <a href="mailto:support@learnai.in" className="hover:text-violet-600">support@learnai.in</a>
        </p>
      </div>
    </div>
  );
